...
void top_level(float* P0, float* P1, float* P2, float* P3, float* P4, float* P5, float* P6, float* P7, float* P8, float* P9, float* P10, float* P11)
{
   ...
   __m_param_alloc(8, 4);
   __m_param_alloc(9, 4);
   __m_param_alloc(10, 4);
   __m_param_alloc(11, 4);
