...
run_bambu () {
  ...
  (
    ...
    bambu "../../../${top}" \
      ...
      -O3 -v4 \
      --generate-tb="../../../${TB}" \
      --tb-param-size=dram_in_b0:128 \
      --tb-param-size=dram_in_b1:128 \
      --tb-param-size=dram_w_b0:32 \
      --tb-param-size=dram_w_b1:32 \
      --tb-param-size=dram_out_b0:16 \
      --tb-param-size=dram_out_b1:16 \
      --tb-param-size=dram_out_b2:16 \
      --tb-param-size=dram_out_b3:16 \
      --tb-param-size=dram_out_b4:16 \
      --tb-param-size=dram_out_b5:16 \
      --tb-param-size=dram_out_b6:16 \
      --tb-param-size=dram_out_b7:16 \
      --tb-param-size=dram_out_b8:16 \
      --tb-param-size=dram_out_b9:16 \
      --tb-param-size=dram_out_b10:16 \
      --tb-param-size=dram_out_b11:16 \
      --tb-param-size=dram_out_b12:16 \
      --tb-param-size=dram_out_b13:16 \
      --tb-param-size=dram_out_b14:16 \
      --tb-param-size=dram_out_b15:16 \
