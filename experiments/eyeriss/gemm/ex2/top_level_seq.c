...
void top_level(DTYPE *dram_w_b0, DTYPE *dram_w_b1, DTYPE *dram_in_b0, DTYPE *dram_in_b1, DTYPE *dram_out_b0, DTYPE *dram_out_b1, DTYPE *dram_out_b2, DTYPE *dram_out_b3, DTYPE *dram_out_b4, DTYPE *dram_out_b5, DTYPE *dram_out_b6, DTYPE *dram_out_b7)
{
    ...
    const int m_sf=8, k_blks=16, M_tiles=4;
    ...
    for (int m = 0; m < M; ++m) {
      for (int n = 0; n < N; ++n) {
        ...
        switch(out_bank) {
          ...
          case 4: dram_out_b4[out_idx] = acc; break;
          case 5: dram_out_b5[out_idx] = acc; break;
          case 6: dram_out_b6[out_idx] = acc; break;
          case 7: dram_out_b7[out_idx] = acc; break;
          default: break;
        }
      }
    }
