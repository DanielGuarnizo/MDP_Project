proc dump_statistics {  } {
  ...
  file delete -force HLS_output/Synthesis/vivado_flow_7/top_level_report.xml 
  set ofile_report [open HLS_output/Synthesis/vivado_flow_7/top_level_report.xml w]
...
set rfile_sdc [open HLS_output/Synthesis/vivado_flow_7/top_level.sdc r]
set clk_constraint [regexp -all --  CLK_SRC [read $rfile_sdc [file size HLS_output/Synthesis/vivado_flow_7/top_level.sdc]]]
if { [expr {$clk_constraint == 0}] } {
  set ofile_sdc [open HLS_output/Synthesis/vivado_flow_7/top_level.sdc a]
  puts $ofile_sdc "set_property HD.CLK_SRC BUFGCTRL_X0Y0 \[get_ports clock\]"
  close $ofile_sdc
}
read_xdc HLS_output/Synthesis/vivado_flow_7/top_level.sdc
