# script_to_xo.tcl — packages read_bm_krnl wrapper as a Vitis XO kernel
...
add_files -norecurse [list \
  [file join $SRC_DIR read_bm_krnl.v] \
  [file join $SRC_DIR read_bm_krnl_translator.v] \
  [file join $SRC_DIR read_bm_krnl_dut.v] \
]
update_compile_order -fileset sources_1
set_property top read_bm_krnl [current_fileset]
update_compile_order -fileset sources_1
...
set_property name         read_bm_krnl [ipx::current_core]
set_property display_name read_bm_krnl [ipx::current_core]
set_property description  "Bambu AXI latency benchmark — read_bm_krnl" [ipx::current_core]
...
set_property size 32 [ipx::get_registers dram_input_p0 -of_objects $ab]

ipx::add_register dram_output_p0 $ab
set_property address_offset 0x014 [ipx::get_registers dram_output_p0 -of_objects $ab]
set_property size 32 [ipx::get_registers dram_output_p0 -of_objects $ab]

ipx::add_register n $ab
set_property address_offset 0x018 [ipx::get_registers n -of_objects $ab]
...
package_xo -force \
  -xo_path     ${XO_DIR}/read_bm_krnl.xo \
  -kernel_name  read_bm_krnl \
  -ip_directory $IP_ROOT \
  -ctrl_protocol ap_ctrl_hs

puts "XO created: ${XO_DIR}/read_bm_krnl.xo"
