...
# Associate pointer-like registers to m_axi_gmem 
foreach r {nodes edges level level_counts queue1 queue2} {
  ipx::add_register_parameter ASSOCIATED_BUSIF [ipx::get_registers $r -of_objects $ab]
  set_property value m_axi_gmem [ipx::get_register_parameters ASSOCIATED_BUSIF -of_objects \
