...
v++ -t hw \
  ...
  --clock.freqHz 100000000:panda_1 \
  --vivado.prop run.impl_1.STEPS.OPT_DESIGN.TCL.PRE="${SCRIPT_DIR}/relax_clock_10ns.tcl" \
  ...
  "--vivado.prop=run.impl_1.STEPS.PLACE_DESIGN.TCL.PRE=${SCRIPT_DIR}/pre_place_combined.tcl" \
  "--vivado.prop=run.impl_1.STEPS.ROUTE_DESIGN.TCL.PRE=${SCRIPT_DIR}/relax_clock_10ns.tcl" \
