          ...
          for (int s = 0; s < 1; ++s) {
            ...
            for (int sarows_1 = 0; sarows_1 < 2; ++sarows_1) {  // M:2
              ...
              for (int sacols_0 = 0; sacols_0 < 4; ++sacols_0) {  // Q:4
                DTYPE weight_value = gb_weight[(outregister_0 * 2 + (sarows_1))][global_channel_index][filter_row_offset][s];
                DTYPE input_value = gb_input[global_channel_index][(dram_0 + filter_row_offset)][output_col_base + sacols_0 + s];
