...
run_bambu () {
  ...
  (
    ...
    bambu "../../../${top}" \
      ...
      -O3 -v4 \
      --generate-tb="../../../${TB}" \
      --tb-param-size=dram_input_p0:64 \
      --tb-param-size=dram_input_p1:64 \
      --tb-param-size=dram_input_p2:64 \
      --tb-param-size=dram_input_p3:64 \
      --tb-param-size=dram_weight_p0:16 \
      --tb-param-size=dram_weight_p1:16 \
      --tb-param-size=dram_weight_p2:16 \
      --tb-param-size=dram_weight_p3:16 \
