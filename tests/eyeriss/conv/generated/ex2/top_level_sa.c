...
void top_level(DTYPE *dram_in_b0, DTYPE *dram_in_b1, DTYPE *dram_w_b0, DTYPE *dram_w_b1, DTYPE *dram_out_b0, DTYPE *dram_out_b1, DTYPE *dram_out_b2, DTYPE *dram_out_b3, DTYPE *dram_out_b4, DTYPE *dram_out_b5, DTYPE *dram_out_b6, DTYPE *dram_out_b7)
{
    ...
    // 96 PE accumulators: acc[3][4][4][2]
    DTYPE acc[3][4][4][2];
      ...
      for (int gb_0 = 0; gb_0 < 8; ++gb_0) {
        ...
        for (int or_0 = 0; or_0 < 4; ++or_0) {
          ...
          for (int r = 0; r < 3; ++r) {
            ...
            // w_tile[3][4][2]: level-indexed, Q absent (weight is Q-independent)
            DTYPE w_tile[3][4][2];
            #pragma GCC unroll 3
            for (int sarows_0 = 0; sarows_0 < 3; ++sarows_0) {
              #pragma GCC unroll 4
              for (int sarows_1 = 0; sarows_1 < 4; ++sarows_1) {
                ...
                for (int sacols_1 = 0; sacols_1 < 2; ++sacols_1) {
                  ...
                  int w_idx = ((or_0 * 2 + (sacols_1)) * ((C + in_banks - 1) / in_banks) + c_blk) * (R * S) + r * S + sarows_0;
            ...
            // p[3][4][4][2]: GCC SROA → 96 scalar float regs
            DTYPE p[3][4][4][2];
            int q_base = dram_0 * 4;
            #pragma GCC unroll 3
          ...
          for (int sacols_0 = 0; sacols_0 < 4; ++sacols_0) {
            ...
            for (int sacols_1 = 0; sacols_1 < 2; ++sacols_1) {
              ...
              DTYPE _t0_2 = acc[1][0][sacols_0][sacols_1] + acc[1][1][sacols_0][sacols_1];
              DTYPE _t0_3 = acc[1][2][sacols_0][sacols_1] + acc[1][3][sacols_0][sacols_1];
              DTYPE _t0_4 = acc[2][0][sacols_0][sacols_1] + acc[2][1][sacols_0][sacols_1];
              DTYPE _t0_5 = acc[2][2][sacols_0][sacols_1] + acc[2][3][sacols_0][sacols_1];
          ...
          for (int sacols_0 = 0; sacols_0 < 4; ++sacols_0) {
            #pragma GCC unroll 2
            for (int sacols_1 = 0; sacols_1 < 2; ++sacols_1) {
              int out_bank = sacols_0*2 + sacols_1;
              int cm = or_0;
              int cp = gb_0;
              int cq = dram_0;
