...
int main() {
    ...
    DTYPE *dram_in_b0 = (DTYPE*)malloc(200 * sizeof(DTYPE));
    DTYPE *dram_in_b1 = (DTYPE*)malloc(200 * sizeof(DTYPE));
    DTYPE *dram_w_b0  = (DTYPE*)malloc(144 * sizeof(DTYPE));
    DTYPE *dram_w_b1  = (DTYPE*)malloc(144 * sizeof(DTYPE));
    ...
    // Zero
    for (size_t i = 0; i < 200; ++i) { dram_in_b0[i]=0.0f; dram_in_b1[i]=0.0f; }
    for (size_t i = 0; i < 144;  ++i) { dram_w_b0[i]=0.0f; dram_w_b1[i]=0.0f; }
...
#ifdef __BAMBU_SIM__
    m_param_alloc(0, 200 * sizeof(DTYPE));
    m_param_alloc(1, 200 * sizeof(DTYPE));
    m_param_alloc(2, 144 * sizeof(DTYPE));
    m_param_alloc(3, 144 * sizeof(DTYPE));
