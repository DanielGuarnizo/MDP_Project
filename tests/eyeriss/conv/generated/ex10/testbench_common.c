...
int main() {
    ...
    DTYPE *dram_in_b0 = (DTYPE*)malloc(216 * sizeof(DTYPE));
    DTYPE *dram_in_b1 = (DTYPE*)malloc(216 * sizeof(DTYPE));
    DTYPE *dram_w_b0  = (DTYPE*)malloc(288 * sizeof(DTYPE));
    DTYPE *dram_w_b1  = (DTYPE*)malloc(288 * sizeof(DTYPE));
    ...
    // Zero
    for (size_t i = 0; i < 216; ++i) { dram_in_b0[i]=0.0f; dram_in_b1[i]=0.0f; }
    for (size_t i = 0; i < 288;  ++i) { dram_w_b0[i]=0.0f; dram_w_b1[i]=0.0f; }
