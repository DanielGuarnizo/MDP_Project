...
int main() {
    ...
    DTYPE *dram_in_b0 = (DTYPE*)malloc(108 * sizeof(DTYPE));
    DTYPE *dram_in_b1 = (DTYPE*)malloc(108 * sizeof(DTYPE));
    ...
    // Zero
    for (size_t i = 0; i < 108; ++i) { dram_in_b0[i]=0.0f; dram_in_b1[i]=0.0f; }
