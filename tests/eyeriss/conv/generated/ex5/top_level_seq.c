                ...
                for (int s = 0; s < 5; ++s) {
                  ...
                  for (int sacols_0 = 0; sacols_0 < 2; ++sacols_0) {  // Q:2
                    ...
                    for (int sacols_1 = 0; sacols_1 < 4; ++sacols_1) {  // M:4
                      DTYPE weight_value = gb_weight[(outregister_0 * 4 + (sacols_1))][global_channel_index][wregister_1][s];
                      DTYPE input_value = gb_input[global_channel_index][(globalbuffer_0 + wregister_1)][output_col_base + sacols_0 + s];
