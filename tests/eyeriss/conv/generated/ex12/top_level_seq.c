      ...
      for (int globalbuffer_0 = 0; globalbuffer_0 < 4; ++globalbuffer_0) {
        ...
        for (int globalbuffer_1 = 0; globalbuffer_1 < 56; ++globalbuffer_1) {
          ...
          for (int outregister_0 = 0; outregister_0 < 16; ++outregister_0) {
            ...
            dram_output_p24[output_dram_offset] = accumulator[24];
            dram_output_p25[output_dram_offset] = accumulator[25];
            dram_output_p26[output_dram_offset] = accumulator[26];
            dram_output_p27[output_dram_offset] = accumulator[27];
          }  // outregister_0
        }  // globalbuffer_1
      }  // globalbuffer_0
    }  // dram_0
