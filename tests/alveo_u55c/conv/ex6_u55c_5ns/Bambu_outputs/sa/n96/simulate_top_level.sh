...
make -f /usr/local/share/panda/libmdpi/Makefile.mk \
  ...
  TB_CFLAGS="" \
  SRCS="/workspace/tests/alveo_u55c/conv/ex6_u55c_5ns/top_level_sa.c" \
  WRAPPER_SRC="${SIM_DIR}/mdpi_wrapper.cpp" \
  PP_SRC="" \
  TB_SRCS="/workspace/tests/alveo_u55c/conv/ex6_u55c_5ns/testbench_common.c" \
  -j ${OMP_NUM_THREADS:-8}
